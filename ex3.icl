...
// 4. Compute for a given positive n the sum of 2i*(2i+1), for i from 1 to n. E.g. for n=3 the 
//    sum is 68.
f :: Int -> Int
f 0 = 0
f x = 2*x*(2*x+1) + f (x-1)
...
//Start = lastdel [[1,2,3],[5,6],[1],[],[0],[7,8,9,10]]
